...
public class BaseClass {
...

	{
		...
		if (System.getProperties().getProperty("os.name").toLowerCase().contains("windows")) {
			System.setProperty("atu.reporter.config", "C:\\Users\\Hasan\\workspace\\Facebook\\atu.properties");
		}
	...
	public static boolean LaunchBrowser(String browser) {
		...
		if (browser.equalsIgnoreCase("firefox")
			...
			System.setProperty("webdriver.ie.driver", "C:\\Users\\Hasan\\workspace\\Facebook\\IEDriverServer.exe");
			...
			System.setProperty("webdriver.chrome.driver", "C:\\Users\\Hasan\\workspace\\Facebook\\chromedriver.exe");
